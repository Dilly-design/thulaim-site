...
const FAQ = () => {
  ...
  const items = [
    ...
    { q: 'هل تقدمون ضيافة رمضان؟', a: 'نعم، ضيافة رمضان خدمة متخصصة عندنا. نصمّم تجربة إفطار وسحور بلمسة نجدية دافئة تناسب بيتك أو شركتك طوال الشهر الكريم.' },
      ...
      <div style={{ display: 'grid', gridTemplateColumns: mobile ? '1fr 1fr' : '1.6fr 1fr 1fr 1fr', gap: mobile ? '40px 24px' : 56, paddingBottom: mobile ? 40 : 64 }}>
        <div>
          ...
          <p style={{ fontFamily: F.text, fontWeight: 300, fontSize: 14, lineHeight: 1.95,
            ...
            بيت ضيافة سعودي حديث مستوحى من الكرم النجدي الأصيل. الرياض، المملكة العربية السعودية.
          </p>
